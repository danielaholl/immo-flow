...
export function CalculatorCards(props: CalculatorCardsProps) {
  const { className = '', canEdit = true, onSaveParams, isSavingParams = false, metricsElement, startInEditMode = false } = props;
  ...
  return (
    <CalculatorContext.Provider value={calculatorState}>
      <div className={`space-y-6 ${className}`}>
        ...
        {/* Fazit-Karte (nur Investor-Modus) */}
        <VerdictCard />
